...
func HTTPRemovesdmSubscriptions(c *gin.Context) {
	logger.DataRepoLog.Debugln("Handle Delete /subscription-data/:ueId/context-data/sdm-subscriptions/:subsId")
...
func HTTPUpdatesdmsubscriptions(c *gin.Context) {
	logger.DataRepoLog.Debugln("Handle Put /subscription-data/:ueId/context-data/sdm-subscriptions/:subsId")
